<footer class="relative">
  <div class="-mt-[39vw] sm:-mt-[33vw] lg:-mt-[24vw] absolute left-0 right-0 w-full pointer-events-none">
      ...
      <div class="relative space-y-8 pb-8">
        <nav class="nav-footer flex items-center justify-center max-w-[400px] mx-auto" aria-label="{{ wp_get_nav_menu_name('footer_navigation') }}">
          {!! wp_nav_menu([
            ...
            'menu_class' => 'font-ga font-bold flex justify-center flex-wrap gap-x-8 gap-y-2',
            'echo' => false,
          ]) !!}
        </nav>
        <div class="flex items-center justify-center gap-6 font-ga font-bold">
          <span>{{ __('Follow us', 'code') }}</span>
        ...
        <div class="text-center font-ga font-bold">
          Valsoia Ⓒ {{ date('Y') }}
        </div>
      </div>
    </div>
