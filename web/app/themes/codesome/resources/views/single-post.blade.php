...
@section('content')
  @while(have_posts()) @php(the_post())
    ...
    <header>
      <h1 class="font-ga font-bold text-3xl lg:text-6xl block max-w-[940px] text-center mx-auto mt-10 mb-10">
        @php(the_title())
      </h1>
    </header>
    <div class="relative">
      ...
      <div class="w-full max-w-[1200px] flex justify-end mb-10 lg:mb-40 px-4">
        @if($next)
          <div>
            <a href="{{ get_permalink($next) }}" class="font-ga font-bold flex flex-col">
      ...
      <section class="relative bg-yellow-1 min-h-[700px] pt-20 pb-[11vw]">
        ...
        <h2 class="font-ga font-bold text-45px leading-12 lg:text-6xl text-center mb-10 sm:mb-16 mt-6 lg:mt-0 px-16 lg:px-0">
