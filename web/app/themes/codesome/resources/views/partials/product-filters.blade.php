<div x-data="{show: false}"
     ...
     class="fixed top-0 left-0 mt-72 transition-all xl:transition-none z-20 bg-white left-0 top-0 bg-whtie rounded-br-[50px] lg:rounded-r-[50px] sm:w-[35vw] lg:w-[27vw] sm:max-w-[470px] font-ga" style="box-shadow: 0 5px 20px #C2790059;">
  <div
